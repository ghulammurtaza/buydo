        ...
        $html .= '<script type="text/javascript">
            var startOptimization = function()
            {
                if (confirm("' . $this->__('It may take a lot of time. Are you sure you want to start the process right now?') . '")) {
                    var optimizationProgressBar = new AjaxRequestProgressBar("' . $this->getUrl('po_compressor_admin/adminhtml_index/optimization') . '", false, function(){optimizationProgressBar.hideMask()}.bind(optimizationProgressBar));
