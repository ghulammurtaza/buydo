<?php
class Gala_Galavineyardsettings_Adminhtml_Galavineyardsettings_ThemeController extends Mage_Adminhtml_Controller_Action
{
	protected $_prefixBlock = 'galavineyard_';
	protected $_prefixPage = 'galavineyard_';
	protected $_packageTheme = 'default/galavineyard';
