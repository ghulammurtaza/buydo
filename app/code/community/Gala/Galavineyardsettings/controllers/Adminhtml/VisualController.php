...
class Gala_Galavineyardsettings_Adminhtml_VisualController extends Mage_Adminhtml_Controller_Action
{    
    function previewBlockAction() {
		$this->getResponse()->setRedirect(Mage::getModel('core/url')->getDirectUrl('galavineyardsettings/visual/previewBlock/key/'.Mage::getSingleton('adminhtml/url')->getSecretKey('cms_block', 'edit')));
	}
